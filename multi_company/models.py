...
class Doisser(models.Model):
    ...
    numero_edof = models.BigIntegerField(null=True, blank=True)
    ...
    date_prevue_d_entree_en_formation = models.DateField(null=True, blank=True)
    date_prevue_de_fin_de_formation = models.DateField(null=True, blank=True)
    
  
    appel_effectue_le_date_time = models.DateField(null=True, blank=True)
    appel_effectue_le_motifs = models.CharField(max_length=300, null=True, blank=True)
    
 
    rdv_confirme_dateandtime = models.DateField(null=True, blank=True)
    ...
    inscription_visio_entree_date_de_facturation = models.DateField(null=True, blank=True)
    inscription_visio_entree_date_d_encaissement = models.DateField(null=True, blank=True)
    ...
    inscription_visio_entree_colis_a_envoyer_le = models.DateField(null=True, blank=True)
